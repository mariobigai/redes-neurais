...
f_treino = open('iris_results_treino.txt','a')
f_teste = open('iris_results_teste.txt','a')
...
plt.savefig(f'Boxplot_iris_treino.png', dpi=500, format='png', orientation='portrait')
plt.show()
...
plt.savefig(f'Boxplot_iris_teste.png', dpi=500, format='png', orientation='portrait')
plt.show()
plt.close(fig_teste)
